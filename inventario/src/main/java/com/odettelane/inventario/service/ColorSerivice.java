...
public interface ColorSerivice {
    ...
    ColorDto read(Integer colorId) throws IdNotProvidedException;
    ColorDto update(ColorDto colorDto, Integer id) throws IdNotProvidedException, AttributeNotProvidedException;
    String delete(Integer colorId) throws IdNotProvidedException;
}
